...
let handler = async (m, { conn, args }) => {
  ...
  try {
    ...
    await conn.sendFile(
      m.chat,
      `https://api.lolhuman.xyz/api/tiktokwm?apikey=${global.lolkey}&url=${args[0]}`,
      "tiktokaudio.mp3",
      `
┏┉━━━━━━━━━━━❏
┆ *YOUTUBE MP3*
...
`.trim(),
      ...
      {
        document: {
          url: `https://api.lolhuman.xyz/api/tiktokwm?apikey=${global.lolkey}&url=${args[0]}`,
        },
        mimetype: "audio/mpeg",
        fileName: "tiktok.mp3",
        conntextInfo: {
          externalAdReply: {
            ...
            mediaType: 2,
            thumbnail: await (
              await fetch("https://telegra.ph/file/9e323ad1f4b2d52579416.jpg")
            ).buffer(),
            mediaUrl: sig,
          },
        },
...
`;
    await conn.sendFile(
      ...
      null,
      {
        document: { url: cer.music.play_url },
        mimetype: "audio/mpeg",
        fileName: "tiktok.mp3",
        conntextInfo: {
          externalAdReply: {
