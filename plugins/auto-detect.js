...
export async function before(m) {
  ...
  const messages = {
    ...
    23: `*mereset* link grup! ♻️`,
    132: `*mereset* link grup! ♻️`,
    24: `mengubah deskripsi grup.\n\n${m.messageStubParameters[0]}`,
    25: `telah mengatur agar *${
      m.messageStubParameters[0] == "on" ? "hanya admin" : "semua peserta"
    }* yang dapat mengedit info grup. 🔧`,
    26: `telah *${
      m.messageStubParameters[0] == "on" ? "menutup" : "membuka"
    }* grup!\nSekarang ${
      m.messageStubParameters[0] == "on" ? "hanya admin yang" : "semua peserta"
    } dapat mengirim pesan. 🔒`,
    29: `telah menjadikan @${
      m.messageStubParameters[0].split("@")[0]
    } sebagai admin. 👨‍💼`,
    30: `telah memberhentikan @${
      m.messageStubParameters[0].split("@")[0]
    } dari admin. 👨‍💼🚪`,
    ...
    143: `menghapus grup komunitas 🗑️`,
