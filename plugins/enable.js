...
→ ${usedPrefix + command} [nomor]`;
  ...
  if (!m.isGroup && !isOwner) {
    conn.reply(
      m.chat,
      "Maaf, fitur ini hanya bisa digunakan di dalam grup oleh pemilik bot.",
      m
    );
    throw false;
  }
  ...
  if (m.isGroup && !isAdmin) {
    conn.reply(
      m.chat,
      "Maaf, fitur ini hanya bisa digunakan oleh admin grup.",
      m
    );
    throw false;
  }
