let handler = async (m, { conn, usedPrefix, participants }) => {
  ...
  m.reply(
    `*Pet Kamu* (🐉naga ${
      global.db.data.users[m.sender].naga
    }) ⚔️menantang 🐉naganya *${conn.getName(lawan)}* (🐉naga ${
      global.db.data.users[lawan].naga
  ...
  let kesempatan = [];
  let i;
  for (i = 0; i < global.db.data.users[m.sender].naga; i++)
  ...
  if (pointPemain > pointLawan) {
    ...
    m.reply(
      `*${conn.getName(m.sender)}* [${pointPemain * 10}] - [${
        ...
        global.db.data.users[m.sender].naga
      }) MENANG melawan 🐉naganya *${conn.getName(lawan)}* (naga ${
        global.db.data.users[lawan].naga
      }) karena naga🐉kamu ${
    ...
    m.reply(
      `*${conn.getName(m.sender)}* [${pointPemain * 10}] - [${
        ...
        global.db.data.users[m.sender].naga
      }) KALAH melawan 🐉naganya *${conn.getName(lawan)}* (naga ${
        global.db.data.users[lawan].naga
      }) karena pet kamu ${
