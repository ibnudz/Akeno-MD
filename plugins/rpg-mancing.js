...
${usedPrefix}cook`;
              setTimeout(() => {
                conn.reply(m.chat, mcng, null);
                if (psepick > 0) {
                  pengguna.psepick += psepick * 1;
                  conn.reply(
                    m.chat,
                    `You Get 🎁chest weapons epic ${psepick} item`,
                    m
                  );
                }
                if (psenjata > 0) {
                  ...
                  conn.reply(
                    m.chat,
                    `You Get 🎁chest weapons ${psenjata} item`,
                    m
                  );
                }
              }, 38000);
              ...
              setTimeout(() => {
                conn.reply(
                  m.chat,
                  `${pemancing} Sepertinya dapat sesuatu..`,
                  null
                );
              }, 28000);
              setTimeout(() => {
            ...
            return conn.reply(
              m.chat,
              `*[❗] kamu tidak punya kail pancingan dan umpan 100 🎣*`,
              m
            );
          break;
...
`.trim();
                ...
                setTimeout(() => {
                  conn.reply(
                    m.chat,
                    `${pemancing} Yuk mancing mania level easy lagi`,
                    null
                  );
                }, 28800000);
                setTimeout(() => {
                ...
                conn.reply(
                  m.chat,
                  "Minimal umpan kamu *100* untuk memancing level mudah",
                  m
                );
            } else
              conn.reply(
                m.chat,
                "Minimal pancingan kamu *Level 2* untuk memancing level mudah",
                m
              );
          } else
            conn.reply(
...
`.trim();
                ...
                setTimeout(() => {
                  conn.reply(
                    m.chat,
                    `${pemancing} Yuk mancing mania level normal lagi`,
                    null
                  );
                }, 28800000);
                setTimeout(() => {
                  conn.reply(m.chat, hsls, null);
                }, 12000);
                setTimeout(() => {
                  conn.reply(m.chat, `${pemancing} Menunggu`, null);
                }, 6000);
...
`.trim();
                ...
                setTimeout(() => {
                  conn.reply(
                    m.chat,
                    `${pemancing} Yuk mancing mania level hard lagi`,
                    null
                  );
                }, 28800000);
                setTimeout(() => {
                  conn.reply(m.chat, hslsh, null);
                }, 12000);
                setTimeout(() => {
                  conn.reply(m.chat, `${pemancing} Menunggu`, null);
                }, 6000);
...
`.trim();
                ...
                setTimeout(() => {
                  conn.reply(
                    m.chat,
                    `${pemancing} Yuk mancing mania level extreme lagi`,
                    null
                  );
                }, 28800000);
                setTimeout(() => {
                  conn.reply(m.chat, hslse, null);
                }, 12000);
                setTimeout(() => {
                  conn.reply(m.chat, `${pemancing} Menunggu`, null);
                }, 6000);
