let handler = async (m, { conn, command, args, text, usedPrefix }) => {
    ...
    let _lmao = args[0];
    let Lmao = `Hanya support 1, 10, 100, 1000\nContoh penggunaan: *${usedPrefix}open ${args > 2 ? _lmao : pickRandom(["common", "uncommon", "mythic", "legendary"])
        } 10*`;
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastime} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "10":
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimeq} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "100":
                    let __lastimeqq =
                        new Date() - global.db.data.users[m.sender].lastopen;
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimeqq} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "1000":
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimeqqq} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                default:
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimew} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "10":
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimewe} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "100":
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimewee} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "1000":
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimeweee} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                default:
...
`.trim();
                        if (global.db.data.users[m.sender].mythic >= 1) {
                            ...
                            if (ml > 0) {
                                conn.reply(
                                    m.chat,
                                    `*Selamat anda mendapatkan item Epic yaitu*\n${ml} Legendary Crate`,
                                    m
                                );
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimep} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "10":
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimepa} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "100":
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimepaa} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "1000":
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimepaaa} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                default:
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimed} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "10":
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimedo} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "100":
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimedoo} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "1000":
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimedooo} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimedz} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "10":
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimedzx} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "100":
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimedzxy} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "1000":
...
`.trim();
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimedzxyk} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                default:
...
`.trim();
            ...
            `.trim()*/
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimeki} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "10":
...
`.trim();
            ...
            `.trim()*/
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimekise} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                default:
...
`.trim();
                        if (global.db.data.users[m.sender].legendary >= 1) {
                            ...
                            if (ll > 0 || lpp > 0) {
                                conn.reply(
                                    m.chat,
                                    `*Selamat anda mendapatkan item Epic yaitu*${ll > 0 ? `\n${ll} Legendary Crate` : ""
                                    }${lpp > 0 ? `\n${lpp} Pet Crate` : ""}`,
                                    m
                                );
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimel} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "10":
...
`.trim();
                        if (global.db.data.users[m.sender].legendary >= 10) {
                            ...
                            if (ll1 > 0 || lpp1 > 0) {
                                conn.reply(
                                    m.chat,
                                    `*Selamat anda mendapatkan item Epic yaitu*${ll1 > 0 ? `\n${ll1} Legendary Crate` : ""
                                    }${lpp1 > 0 ? `\n${lpp1} Pet Crate` : ""}`,
                                    m
                                );
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimele} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "100":
...
`.trim();
                        if (global.db.data.users[m.sender].legendary >= 100) {
                            ...
                            if (ll2 > 0 || lpp2 > 0) {
                                conn.reply(
                                    m.chat,
                                    `*Selamat anda mendapatkan item Epic yaitu*${ll2 > 0 ? `\n${ll2} Legendary Crate` : ""
                                    }${lpp2 > 0 ? `\n${lpp2} Pet Crate` : ""}`,
                                    m
                                );
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimelee} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                case "1000":
...
`.trim();
                        if (global.db.data.users[m.sender].legendary >= 1000) {
                            ...
                            if (ll3 > 0 || lpp3 > 0) {
                                conn.reply(
                                    m.chat,
                                    `*Selamat anda mendapatkan item Epic yaitu*${ll3 > 0 ? `\n${ll3} Legendary Crate` : ""
                                    }${lpp3 > 0 ? `\n${lpp3} Pet Crate` : ""}`,
                                    m
                                );
                        ...
                        conn.reply(
                            m.chat,
                            `Mohon tunggu ${lastimeleee} lagi untuk bisa membuka fitur open`,
                            m
                        );
                    break;
                default:
        ...
        case "pet":
            ...
            let randpet = `${pickRandom([
                "Anda kurang beruntung",
                "Coba buka lagi lain kali, karena gk dapet pet",
                "kasian gk dapet pet",
                "Mungkin lagi gk hoki dan gk dapet pet",
                "wkwkkwkwke",
            ])}`.trim();
            ...
            if (new Date() - global.db.data.users[m.sender].lastopen > 30000) {
                ...
                if (global.db.data.users[m.sender].pet > 0) {
                    ...
                    if (_pet == "kucing" && kucing > 0) {
                        ...
                        conn.reply(
                            m.chat,
                            `Anda sudah memiliki pet ${_pet}, Hadiahmu diganti dengan 2 potion${mknp > 0 ? ` Dan ${mknp} Makanan Pet` : ""
                            }`,
                            m
                        );
                        ...
                        conn.reply(
                            m.chat,
                            `*Selamat Anda mendapatkan pet ${_pet} ${mknp > 0 ? ` Dan ${mknp} Makanan Pet*` : "*"
                            }`,
                            m
                        );
                        ...
                        conn.reply(
                            m.chat,
                            randpet + "Anda hanya mendapatkan *" + mknp + "* makanan pet",
                            m
                        );
                    }
                ...
                conn.reply(
                    m.chat,
                    `Mohon tunggu ${lastimepet} lagi untuk bisa membuka fitur open`,
                    m
                );
            break;
        default:
