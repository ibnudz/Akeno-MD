  ...
  if (args[0] == "blackpink" || args[0] == "exo" || args[0] == "bts") {
    fetch(
      ...
      .catch(() => {
        conn.reply(
          m.chat,
          "Terjadi kesalahan, coba lagi. Jika masalah berlanjut, beri tahu pembuat saya",
          m
        );
      });
  } else {
    conn.reply(
      m.chat,
      `Maaf, pencarian tidak tersedia. Silakan tulis ${usedPrefix}kpop untuk melihat daftar pencarian yang tersedia`,
      m
    );
  }
};
