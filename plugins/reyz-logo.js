    ...
    Object.keys(res).map((v, index) => {
      listSections.push([
        ...
        [
          [
            res[v].toUpperCase(),
            usedPrefix + command + "get " + res[v] + "|" + text,
            "",
          ],
        ],
      ]);
...
function Logo(efek, teks1, teks2) {
  try {
    if (efek == "kaneki") {
      return (
        "https://api.caliph.biz.id/api/kaneki?nama=" +
        teks1 +
        "&apikey=caliphkey"
      );
    } else if (efek == "lolimaker") {
      return (
        "https://api.caliph.biz.id/api/lolimaker?nama=" +
        teks1 +
        "&nama2=" +
        teks2 +
        "&apikey=caliphkey"
      ...
      return (
        "https://api.caliph.biz.id/api/girlneko?nama=" +
        teks1 +
        "&nama2=" +
        teks2 +
        "&apikey=caliphkey"
      ...
      return (
        "https://api.caliph.biz.id/api/rem?nama=" + teks1 + "&apikey=caliphkey"
      );
    } else if (efek == "sadboy") {
      return (
        "https://api.caliph.biz.id/api/sadboy?nama=" +
        teks1 +
        "&nama2=" +
        teks2 +
        "&apikey=caliphkey"
