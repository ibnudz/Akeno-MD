  ...
  let quests = [
    ...
    },
    {
      pertanyaan: [
        ...
        "Apa nama ilmuwan yang menemukan hukum gravitasi?",
      ],
    ...
    },
    {
      pertanyaan: [
        ...
        "Apa nama hewan tercepat di dunia?",
        "Berapakah 10 + 10?",
      ],
    ...
    },
    {
      pertanyaan: [
        ...
        "Berapakah 8 x 8?",
        "Siapa penemu teori relativitas umum?",
      ],
    ...
    {
      pertanyaan: [
        "Apa nama tokoh fiksi paling terkenal dari Jepang?",
        "Apa simbol kimia untuk emas?",
        "Apa lambang dari planet Merkurius?",
      ],
      jawaban: ["doraemon", "au", "☿"],
    ...
    {
      pertanyaan: [
        "Apa nama tokoh kartun yang memakai baju bergaris merah putih?",
        "Apa simbol kimia untuk nitrogen?",
        "Berapakah 10 + 15?",
      ],
    ...
    {
      pertanyaan: [
        "Apa nama alat musik gesek yang memiliki empat senar?",
        "Apa simbol kimia untuk belerang?",
        "Berapakah 7 x 7?",
      ],
      jawaban: ["biola", "s", "49"],
    ...
    {
      pertanyaan: [
        "Apa warna daun saat musim semi?",
        "Apa nama planet terbesar kedelapan di tata surya?",
        "Apa bahasa resmi di Jerman?",
      ],
    ...
    {
      pertanyaan: [
        "Siapa tokoh kartun anjing yang berwarna hitam dan putih?",
        "Apa simbol kimia untuk tembaga?",
        "Berapakah 16 ÷ 4?",
      ],
      jawaban: ["goofy", "cu", "4"],
    ...
    {
      pertanyaan: [
        "Apa nama binatang yang berbisa dan melata?",
        "Apa bahasa resmi di Korea Utara?",
        "Berapakah 36 - 18?",
      ],
    ...
    {
      pertanyaan: [
        "Apa nama tanaman yang menghasilkan teh?",
        "Apa bahasa resmi di Italia?",
        "Berapakah 6 x 9?",
      ],
    ...
    {
      pertanyaan: [
        "Apa warna langit saat malam hari?",
        "Apa nama planet terbesar keenam di tata surya?",
        "Apa bahasa resmi di Korea Selatan?",
      ],
    ...
    {
      pertanyaan: [
        "Siapa penulis novel 'The Great Gatsby'?",
        "Apa simbol kimia untuk seng?",
        "Berapakah 125 ÷ 5?",
      ],
    ...
    {
      pertanyaan: [
        "Apa nama film trilogi 'The Lord of the Rings'?",
        "Apa simbol kimia untuk oksigen?",
        "Berapakah 100 - 25?",
      ],
    ...
    {
      pertanyaan: [
        "Siapa penulis drama 'Romeo and Juliet'?",
        "Apa bahasa resmi di Thailand?",
        "Berapakah 15 + 8?",
      ],
    ...
    {
      pertanyaan: [
        "Apa nama alat musik tiup yang terbuat dari logam?",
        "Apa simbol kimia untuk air raksa?",
        "Berapakah 18 x 4?",
      ],
    ...
    {
      pertanyaan: [
        "Siapa tokoh kartun yang tinggal di rumah nanas di dasar laut?",
        "Apa simbol kimia untuk perak?",
        "Berapakah 30 - 12?",
      ],
    ...
    {
      pertanyaan: [
        "Apa nama binatang yang bisa terbang?",
        "Apa bahasa resmi di India?",
        "Berapakah 24 x 3?",
      ],
    ...
    {
      pertanyaan: [
        "Siapa penulis novel 'To Kill a Mockingbird'?",
        "Apa simbol kimia untuk karbon?",
        "Berapakah 50 + 25?",
      ],
    ...
    {
      pertanyaan: [
        "Apa nama tanaman yang menghasilkan kopi?",
        "Apa bahasa resmi di Inggris?",
        "Berapakah 16 x 9?",
      ],
    ...
    {
      pertanyaan: [
        "Apa warna langit saat siang hari?",
        "Apa nama planet terbesar kelima di tata surya?",
        "Apa bahasa resmi di China?",
      ],
    ...
    {
      pertanyaan: [
        "Apa nama tokoh kartun yang menggunakan topi merah dengan kacamata?",
        "Apa simbol kimia untuk besi?",
    ...
    },
    {
      pertanyaan: [
        ...
        "Apa nama planet terdekat dengan Bumi?",
        "Apa bahasa resmi di Rusia?",
      ],
    ...
    {
      pertanyaan: [
        "Apa nama binatang karnivora terbesar di dunia?",
        "Apa simbol kimia untuk kalsium?",
        "Berapakah 20 + 30?",
      ],
      jawaban: ["singa", "ca", "50"],
    ...
    {
      pertanyaan: [
        "Apa warna matahari saat terbenam?",
        "Apa nama planet terkecil di tata surya?",
        "Apa bahasa resmi di Spanyol?",
      ],
...
async function handler(m, { conn, text }) {
  ...
  if (m.sender in conn.quest) {
    if (
      conn.quest[m.sender].currentQuestion >=
      conn.quest[m.sender].pertanyaan.length
    ) {
      return m.reply("🏆 Anda telah menyelesaikan semua questgame.");
    }
    return m.reply(
      "⏳ Anda masih memiliki questgame yang belum selesai. Silakan selesaikan terlebih dahulu."
    );
  } else {
    if (text === "start") {
      ...
      if (user.health === 0 || user.stamina === 0 || user.mana === 0)
        return m.reply("❗ Stamina/health/mana Anda kurang dari 100.");
      if (typeof user.exp !== "number") global.db.data.users[m.sender].exp = 0;
      if (typeof user.crystal !== "number")
        global.db.data.users[m.sender].crystal = 0;
      if (typeof user.lastGameTime !== "number")
        global.db.data.users[m.sender].lastGameTime = 0;
      ...
      if (timers > 0)
        return m.reply(
          `Silakan tunggu ${formatTime(
            timers
          )} lagi sebelum memulai questgame baru.`
        );
      ...
      instructions +=
        "Ketik *'stop'* untuk menghentikan game saat sedang bermain.\n";
      instructions +=
        "Ketik *'hint'* untuk mendapatkan petunjuk dari jawaban saat sedang bermain.";
...
handler.before = async (m) => {
  ...
  let { pertanyaan, jawaban, reward, currentQuestion, jawabanBenar } =
    conn.quest[m.sender];
  ...
  if (txt === "stop") {
    m.reply(
      "❌ Game quest telah dihentikan. Ketik *'questgame start'* untuk memulai game kembali."
    );
    delete conn.quest[m.sender];
    return false;
  } else if (txt === "hint") {
    let clue = `🔍 Clue untuk soal ${currentQuestion + 1}: ${getClue(
