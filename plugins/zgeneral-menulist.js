...
⬡│☂︎ *Version:* ${v}
⬡│☂︎ *Creator:* ${author}
⬡│☂︎ *Mode:* ${global.opts["sᴇʟғ"] ? "ᴘʀɪᴠᴀᴛᴇ" : "ᴘᴜʙʟɪᴄ"}
⬡│☂︎ *No Own:* ${global.nomorown}
┬│☂︎ *Database:* ${Object.keys(global.db.data.users).length}
│╰────────────────···
╰──────────═┅═──────────    
${readMore}\n╭━━━━━━━━┈─◂\n│≡ *TAG LIST*\n┴\n│${
          global.htjava
    ...
    // Menampilkan semua tag dan bantuan
    let name = m.pushName || conn.getName(m.sender);
    const more = String.fromCharCode(8206);
    const readMore = more.repeat(4001);
...
${readMore}\n╭━━━━━━━━┈─◂\n│≡ *TAG LIST AND HELP*\n╰━━━━━━━━┈─◂\n\n${allTagsAndHelp}\n\n*Total Tags:${
    ...
    conn.sendMessage(
      m.chat,
      `Tag '${perintah}' tidak ditemukan. Gunakan 'menulist tags' atau 'menulist all' untuk melihat tag yang tersedia.`,
      { quoted: m, ephemeralExpiration: global.ephemeral }
    );
  }
};
