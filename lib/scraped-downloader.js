...
function spotifyDown(url) {
  return new Promise((resolve, reject) => {
    ...
    axios
      .get("https://spotify-api.caliph.my.id" + "/api/info/track", {
        params: { url },
      })
...
function spotifySearch(q) {
  return new Promise((resolve, reject) => {
    ...
    axios
      .get("https://spotify-api.caliph.my.id" + "/api/search/tracks", {
        params: { q },
      })
      .then((b) => resolve(b.data))
      .catch(reject);
...
function ttdown(url) {
  return new Promise((resolve, reject) => {
    if (!url) return reject(new Error("url input is required"));
    axios
      .get("https://developers.tiklydown.me" + "/api/download", {
        params: { url },
      })
      .then((b) => resolve(b.data))
      .catch(reject);
...
function ttdown2(url) {
  return new Promise((resolve, reject) => {
    if (!url) return reject(new Error("url input is required"));
    axios
      .get("https://developers.tiklydown.me" + "/api/download/v2", {
        params: { url },
      })
      .then((b) => resolve(b.data))
      .catch(reject);
