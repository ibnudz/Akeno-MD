  ...
  return new Promise((resolve, reject) => {
    fetch(
      ...
      .then((res) => {
        ...
        data.splice(2, 1);
        if (data.length == 0)
          return resolve({ creator: "Wudysoft", status: false });
...
async function srexdldown(link) {
  return new Promise((resolve) => {
    axios.get(link).then(({ data }) => {
      ...
      const link_name = [];
      const judul = $(
        "#page > div > div > div > section > div:nth-child(2) > article > div > h1.post-title"
      ).text();
      const plink = $(
        "#page > div > div > div > section > div:nth-child(2) > center:nth-child(3) > h2 > span > a"
      ).attr("href");
      axios.get(plink).then(({ data }) => {
        ...
        resolve({
          ...
          judul: judul,
          update_date: $$(
            "#dlbox > ul.dl-list > li.dl-update > span:nth-child(2)"
          ).text(),
          version: $$(
            "#dlbox > ul.dl-list > li.dl-version > span:nth-child(2)"
          ).text(),
          size: $$(
            "#dlbox > ul.dl-list > li.dl-size > span:nth-child(2)"
          ).text(),
          download: link,
        });
      });
...
async function smerdekanews() {
  return new Promise((resolve) => {
    axios.get("https://www.merdeka.com/peristiwa/").then(({ data }) => {
      ...
      const thumb = [];
      const result = [];
      $("#mdk-content-center > div.inner-content > ul > li > div").each(
        function (a, b) {
          let deta = $(b).find("h3 > a").text();
          judul.push(deta);
          link.push(
            "https://www.merdeka.com" + $(b).find("h3 > a").attr("href")
          );
...
async function sasupanfilminfo(link) {
  return new Promise((resolve) => {
    axios.get(link).then(({ data }) => {
      ...
      const info = {
        judul: $(
          "body > div > div:nth-child(5) > div.card-body.p-2 > ul > li:nth-child(1)"
        ).text(),
        thumb: $("body > div > div.card.mb-3 > div.card-footer > a").attr(
          "href"
        ),
        alurcerita_imdb: $(
          "body > div > div:nth-child(5) > div.card-body.p-2 > ul > li:nth-child(2)"
        )
          .text()
          .split(" Alur Cerita IMDb: ")[1],
        alurcerita_tmdb: $(
          "body > div > div:nth-child(5) > div.card-body.p-2 > ul > li:nth-child(3)"
        )
          .text()
          .split(" Alur Cerita TMDb: ")[1],
        direksi: $(
          "body > div > div:nth-child(5) > div.card-body.p-2 > ul > li:nth-child(4)"
        )
          .text()
          .split(" Direksi: ")[1],
        pemeran: $(
          "body > div > div:nth-child(5) > div.card-body.p-2 > ul > li:nth-child(5)"
        )
          .text()
          .split(" Pemeran: ")[1],
        kategori: $(
          "body > div > div:nth-child(5) > div.card-body.p-2 > ul > li:nth-child(6)"
        )
          .text()
          .split(" Kategori: ")[1],
        negara: $(
          "body > div > div:nth-child(5) > div.card-body.p-2 > ul > li:nth-child(7)"
        )
          .text()
          .split(" Negara: ")[1],
        tahun_rilis: $(
          "body > div > div:nth-child(5) > div.card-body.p-2 > ul > li:nth-child(8)"
        )
          .text()
          .split(" Tahun Rilis: ")[1],
        durasi: $(
          "body > div > div:nth-child(5) > div.card-body.p-2 > ul > li:nth-child(9)"
        )
          .text()
          .split(" Durasi: ")[1],
        skor: $(
          "body > div > div:nth-child(5) > div.card-body.p-2 > ul > li:nth-child(10)"
        )
          .text()
          .split(" Skor: ")[1],
        kualitas: $(
          "body > div > div:nth-child(5) > div.card-body.p-2 > ul > li:nth-child(11)"
        )
          .text()
          .split(" Kualitas: ")[1],
        jenis: $(
          "body > div > div:nth-child(5) > div.card-body.p-2 > ul > li:nth-child(12)"
        )
          .text()
          .split(" Jenis: ")[1],
      };
...
async function srandomtt(query) {
  return new Promise((resolve, reject) => {
    axios.get("https://brainans.com/search?query=" + query).then(({ data }) => {
      const $ = cheerio.load(data);
      const luser = $(
        "#search-container > div:nth-child(1) > div.content__text > a"
      ).attr("href");
      axios.get("https://brainans.com/" + luser).then(({ data }) => {
        const $$ = cheerio.load(data);
        let vlink = [];
        $$(
          "#videos_container > div > div.content__list.grid.infinite_scroll.cards > div > div > a"
        ).each(function (a, b) {
        ...
        randomarray(vlink).then((res) => {
          axios.get(res).then(({ data }) => {
            ...
            resolve({
              username: $$$(
                "#card-page > div > div.row > div > div > div > div > div.main__user-desc.align-self-center.ml-2 > a"
              ).text(),
              caption: $$$(
                "#card-page > div > div.row > div > div > div.main__info.mb-4 > div.main__list"
              ).text(),
              like_count: $$$(
                "#card-page > div > div.row > div > div > div.main__info.mb-4 > div > div:nth-child(1) > span"
              ).text(),
              comment_count: $$$(
                "#card-page > div > div.row > div > div > div.main__info.mb-4 > div.content__btns.d-flex > div:nth-child(2) > span"
              ).text(),
              share_count: $$$(
                "#card-page > div > div.row > div > div > div.main__info.mb-4 > div.content__btns.d-flex > div:nth-child(3) > span"
              ).text(),
              videourl: $$$(
                "#card-page > div > div.row > div > div > div.main__info.mb-4 > div.main__image-container > div > video"
              ).attr("src"),
            });
          });
        });
...
async function schara(query) {
  return new Promise((resolve, reject) => {
    axios
      .get(
        `https://www.anime-planet.com/characters/all?name=${query}&sort=likes&order=desc`
      )
      .then((data) => {
        const $ = cheerio.load(data.data);
        const linkp = $(
          "#siteContainer > table > tbody > tr:nth-child(1) > td.tableCharInfo > a"
        ).attr("href");
        axios.get("https://www.anime-planet.com" + linkp).then((data) => {
          ...
          resolve({
            ...
            gender: $$(
              "#siteContainer > section.pure-g.entryBar > div:nth-child(1)"
            )
              .text()
              .split("\nGender: ")[1],
            warna_rambut: $$(
              "#siteContainer > section.pure-g.entryBar > div:nth-child(2)"
            )
              .text()
              .split("\nHair Color: ")[1],
            warna_mata: $$(
              "#siteContainer > section:nth-child(11) > div > div > div > div > div:nth-child(1) > div"
            )
              .text()
              .split("\n")[1],
            gol_darah: $$(
              "#siteContainer > section:nth-child(11) > div > div > div > div > div:nth-child(2) > div"
            )
              .text()
              .split("\n")[1],
            birthday: $$(
              "#siteContainer > section:nth-child(11) > div > div > div > div > div:nth-child(3) > div"
            )
              .text()
              .split("\n")[1],
            description: $$(
              "#siteContainer > section:nth-child(11) > div > div > div > div:nth-child(1) > p"
            ).text(),
          });
        });
      })
  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then((data) => {
        ...
        const link = [];
        const thumb = [];
        $("#siteContainer > ul.cardDeck.cardGrid > li > a > h3").each(function (
          a,
          b
        ) {
          let deta = $(b).text();
        ...
        $("#siteContainer > ul.cardDeck.cardGrid > li > a").each(function (
          a,
          b
        ) {
        ...
        $(
          "#siteContainer > ul.cardDeck.cardGrid > li > a > div.crop > img"
        ).each(function (a, b) {
  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then((data) => {
        ...
        const upload = [];
        $(
          "#jobList > div > div:nth-child(3) > div > div > div > div > article > div > div > div > div > div > h1 > a > div"
        ).each(function (a, b) {
          let deta = $(b).text();
          job.push(deta);
        });
        $(
          "#jobList > div > div:nth-child(3) > div > div > div > div > article > div > div > div > div > div > span"
        ).each(function (a, b) {
          let deta = $(b).text();
          perusahaan.push(deta);
        });
        $(
          "#jobList > div > div:nth-child(3) > div > div > div > div > article > div > div > div > div > span > span"
        ).each(function (a, b) {
          let deta = $(b).text();
          daerah.push(deta);
        });
        $(
          "#jobList > div > div:nth-child(3) > div > div > div > div > article > div > div > div > div > div > h1 > a"
        ).each(function (a, b) {
          link.push($(b).attr("href"));
        });
        $(
          "#jobList > div > div:nth-child(3) > div > div > div > div > article > div > div > div.sx2jih0.zcydq852.zcydq842.zcydq872.zcydq862.zcydq82a.zcydq832.zcydq8d2.zcydq8cq > div.sx2jih0.zcydq832.zcydq8cq.zcydq8c6.zcydq882 > time > span"
        ).each(function (a, b) {
          let deta = $(b).text();
          upload.push(deta);
        });
  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then(({ data }) => {
        ...
        const uptime = [];
        $(
          "body > div.wrap > div.container > div.column-content > a > div > div.amvj > h3"
        ).each(function (a, b) {
          let jud = $(b).text();
          judul.push(jud);
        });
        $(
          "body > div.wrap > div.container > div.column-content > a > div > div.jamup"
        ).each(function (c, d) {
          let upt = $(d).text();
          uptime.push(upt);
        });
        $(
          "body > div.wrap > div.container > div.column-content > a > div > amp-img"
        ).each(function (e, f) {
  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then(({ data }) => {
        ...
        resolve({
          judul: $(
            "body > div.wrap > div.container > div.pagetitle > h1"
          ).text(),
          uptime: $(
            "body > div.wrap > div.container > div.pagetitle > div > div > span > time"
          ).text(),
          direct_link: $("#tontonin > source").attr("src"),
          mforu: {
            SD: $("#colomb > p > span:nth-child(1) > a:nth-child(3)").attr(
              "href"
            ),
            HD: $("#colomb > p > span:nth-child(1) > a:nth-child(5)").attr(
              "href"
            ),
          },
          zippy: {
            SD: $("#colomb > p > span:nth-child(3) > a:nth-child(3)").attr(
              "href"
            ),
            HD: $("#colomb > p > span:nth-child(3) > a:nth-child(5)").attr(
              "href"
            ),
          },
          mirror: {
            SD: $("#colomb > p > span:nth-child(5) > a:nth-child(3)").attr(
              "href"
            ),
            HD: $("#colomb > p > span:nth-child(5) > a:nth-child(5)").attr(
              "href"
            ),
          },
        });
  ...
  return new Promise(async (resolve, reject) => {
    axios
      ...
      .then(({ data }) => {
        ...
        const rasa = teks;
        const format = {
          imagemap: $("div.modal-body > div > div:nth-child(1) > img").attr(
            "src"
          ),
          magnitude: $(
...
async function srandomgore() {
  return new Promise(async (resolve, reject) => {
    ...
    axios.get(slink).then(({ data }) => {
      ...
      const username = [];
      const linkp = $(
        `#post-items > li:nth-child(${randvid}) > article > div.post-thumbnail > a`
      ).attr("href");
      const thumbb = $(
        `#post-items > li:nth-child(${randvid}) > article > div.post-thumbnail > a > div > img`
      ).attr("src");
      axios
        .get(linkp)
        .then(({ data }) => {
  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then(({ data }) => {
        ...
        const link = [];
        const format = [];
        $("#content > div > div > div.appRow > div > div > div > h5 > a").each(
          function (a, b) {
            let nem = $(b).text();
            nama.push(nem);
          }
        );
        $("#content > div > div > div.appRow > div > div > div > a").each(
          function (c, d) {
            let dev = $(d).text();
            developer.push(dev);
          }
        ...
        $(
          "#content > div > div > div.appRow > div > div > div > div.downloadIconPositioning > a"
        ).each(function (e, f) {
          link.push("https://www.apkmirror.com" + $(f).attr("href"));
        });
        $(
          "#content > div > div > div.infoSlide > p > span.infoslide-value"
        ).each(function (g, h) {
          let data = $(h).text();
          if (data.match("MB")) {
            size.push(data);
  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then(({ data }) => {
        ...
        const other = link.split("/")[7].split("&is")[0];
        const format = {
  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then(({ data }) => {
        ...
        const format = [];
        $(
          "body > div.page > div > div > div.app_list > div > div > div.cont > div.data > div.name > a > span"
        ).each(function (a, b) {
          let nem = $(b).text();
          nama.push(nem);
        });
        ...
        $(
          "body > div.page > div > div > div.app_list > div > div > div.cont > div.data > div.developer.xsmf.muted"
        ).each(function (e, f) {
          let dev = $(f).text();
          developer.push(dev);
        });
        $(
          "body > div.page > div > div > div.app_list > div > div > div.img > img"
        ).each(function (g, h) {
          thumb.push($(h).attr("src"));
        });
        $(
          "body > div.page > div > div > div.app_list > div > div > div.cont > div.data > div.name > a"
        ).each(function (i, j) {
  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then(({ data }) => {
        ...
        const format = [];
        $(
          "#primary > section:nth-child(3) > div > div > div > article > a > div > div > div > h2"
        ).each(function (a, b) {
          let nem = $(b).text();
          nama.push(nem);
        });
        $(
          "#primary > section:nth-child(3) > div > div > div > article > a > div > div > p"
        ).each(function (c, d) {
          let modd = $(d).text();
          mod.push(modd.split("\n")[1]);
        });
        $(
          "#primary > section:nth-child(3) > div > div > div > article > a > div > img"
        ).each(function (e, f) {
          thumb.push($(f).attr("src"));
        });
        $(
          "#primary > section:nth-child(3) > div > div > div > article > a"
        ).each(function (g, h) {
          link.push($(h).attr("href"));
        });
        for (let i = 0; i < link.length; i++) {
  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then(({ data }) => {
        ...
        const username = [];
        $(
          "#js-pjax-container > div.container-xl.px-3.px-md-4.px-lg-5 > div > div.flex-shrink-0.col-12.col-md-9.mb-4.mb-md-0 > div > div > div > div.d-table-cell.col-9.v-align-top.pr-3 > a"
        ).each(function (a, b) {
          link.push("https://github.com/" + $(b).attr("href"));
        ...
        const hasil = {
          username: $(
            ...
            .replace("          ", ""),
          followers: $(
            "#js-pjax-container > div.container-xl.px-3.px-md-4.px-lg-5 > div > div.flex-shrink-0.col-12.col-md-3.mb-4.mb-md-0 > div > div.js-profile-editable-replace > div.d-flex.flex-column > div.js-profile-editable-area.d-flex.flex-column.d-md-block > div.flex-order-1.flex-md-order-none.mt-2.mt-md-0 > div > a:nth-child(1) > span"
          ).text(),
          avatar: $(
            "#js-pjax-container > div.container-xl.px-3.px-md-4.px-lg-5 > div > div.flex-shrink-0.col-12.col-md-3.mb-4.mb-md-0 > div > div.js-profile-editable-replace > div.clearfix.d-flex.d-md-block.flex-items-center.mb-4.mb-md-0 > div.position-relative.d-inline-block.col-2.col-md-12.mr-3.mr-md-0.flex-shrink-0 > a > img"
          ).attr("src"),
...
async function smangatoon(search) {
  ...
  try {
    const res = await axios.get(
      `https://mangatoon.mobi/en/search?word=${search}`,
      {
        method: "GET",
        headers: {
          "User-Agent":
    ...
    let filt = hasil.filter(
      (v) => v.comic_name !== undefined && v.comic_type !== undefined
    );
    return filt;
  } catch (eror404) {
...
async function spalingmurah(produk) {
  ...
  try {
    const res = await axios.get(
      `https://palingmurah.net/pencarian-produk/?term=` + produk
    );
    const hasil = [];
    const $ = cheerio.load(res.data);
    $("div.ui.card.wpj-card-style-2 ").each(function (a, b) {
      ...
      let product_desc = $(b)
        .find("div.description.visible-on-list")
        .text()
        .trim();
      let price = $(b)
        .find("div.flex-master.card-job-price.text-right.text-vertical-center")
        .text()
        .trim();
      const result = {
        status: res.status,
  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then(({ data }) => {
        ...
        $(
          "#content > div.postbody > div > div > ul > li > div.dtl > div.footer-content-post.fotdesktoppost > div.contentleft > span:nth-child(1) > rating > ratingval > ratingvalue"
        ).each(function (c, d) {
          let rate = $(d).text();
  ...
  return new Promise((resolve, reject) => {
    axios
      ...
      .then(({ data }) => {
        ...
        axios.get(no).then(({ data }) => {
          const $ = cheerio.load(data);
          const result = [];
          $(
            "#root > main > div > div._2QovI > div._2rKEX._17aAh._1bdC8 > div > div._2HK_1 > div._1lkTS > div > img"
          ).each(function (a, b) {
